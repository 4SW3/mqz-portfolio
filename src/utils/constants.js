...
export const colors = {
  ...
  'game-wiki-and-build-editor': { bg: colorDark, cl: colorLight },
  'bugtracker': { bg: colorLight, cl: colorDark },
  'shader-fbm': { bg: colorDark, cl: colorLight },
}
